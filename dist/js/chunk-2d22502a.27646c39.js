(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["chunk-2d22502a"],
  {
    e328: function(e, t, n) {
              ...
              this._worker(e)
                .then(function(n) {
                  ...
                  var r = [],
                    ...
                    i = o.noSyntaxValidation,
                    a = o.noSemanticValidation;
                  return (
                    i || r.push(n.getSyntacticDiagnostics(e.toString())),
                    a || r.push(n.getSemanticDiagnostics(e.toString())),
                    Promise.all(r)
                  );
                })
                .then(function(n) {
        ...
        g = (function(e) {
          ...
          return (
            ...
            (t.prototype.provideCompletionItems = function(e, n, r, o) {
              var i = e.getWordUntilPosition(n),
                a = new c(
                  n.lineNumber,
                  i.startColumn,
                  n.lineNumber,
                ...
                s = e.uri,
                u = this._positionToOffset(s, n);
              return this._worker(s)
                .then(function(e) {
                  return e.getCompletionsAtPosition(s.toString(), u);
                })
                .then(function(r) {
                  if (r) {
                    var o = r.entries.map(function(r) {
                      var o = a;
                      if (r.replacementSpan) {
                        var i = e.getPositionAt(r.replacementSpan.start),
                          u = e.getPositionAt(
                ...
                .then(function(e) {
                  return e
                    ? {
                        ...
                        documentation: { value: p(e.documentation) }
                      }
                    : a;
                });
            }),
                    ...
                    return (
                      e.items.forEach(function(e) {
                        ...
                        (n.label += p(e.prefixDisplayParts)),
                          e.parameters.forEach(function(t, r, o) {
                            var i = p(t.displayParts),
                              a = {
                                label: i,
          ...
          return (
            ...
            (t.prototype.provideDocumentSymbols = function(e, t) {
              ...
              return this._worker(r)
                .then(function(e) {
                  return e.getNavigationBarItems(r.toString());
                })
                .then(function(e) {
                  if (e) {
                    var t = function(e, o, i) {
                        var a = {
                          ...
                          detail: "",
                          kind:
                            w[o.kind] || monaco.languages.SymbolKind.Variable,
                          range: n._textSpanToRange(r, o.spans[0]),
                          selectionRange: n._textSpanToRange(r, o.spans[0]),
                          containerName: i
                        };
                        if (o.childItems && o.childItems.length > 0)
                          for (var s = 0, u = o.childItems; s < u.length; s++) {
                            var c = u[s];
                            t(e, c, a.name);
                          }
                        e.push(a);
      ...
      function D() {
        return new Promise(function(e, t) {
          if (!x) return t("TypeScript not registered!");
          e(x);
        });
      }
      function A(e, t) {
        ...
        return (
          monaco.languages.registerCompletionItemProvider(t, new g(r)),
          monaco.languages.registerSignatureHelpProvider(t, new d(r)),
          monaco.languages.registerHoverProvider(t, new h(r)),
          monaco.languages.registerDocumentHighlightProvider(t, new v(r)),
          monaco.languages.registerDefinitionProvider(t, new b(r)),
          monaco.languages.registerReferenceProvider(t, new _(r)),
          monaco.languages.registerDocumentSymbolProvider(t, new y(r)),
          monaco.languages.registerDocumentRangeFormattingEditProvider(
            t,
            new C(r)
          ),
          monaco.languages.registerOnTypeFormattingEditProvider(t, new I(r)),
          new m(e, t, r),
          r
        );
      }
...
//# sourceMappingURL=chunk-2d22502a.27646c39.js.map
