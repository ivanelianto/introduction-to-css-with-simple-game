    ...
    db4f: function(e, n, t) {
      ...
      (function(e) {
        ...
        (function(e) {
          ...
          function t(e) {
            var n = e;
            return i.is(n.range) && u.is(n.color);
          }
          (e.create = n), (e.is = t);
        })(s || (s = {})),
        (function(e) {
        ...
        (function(e) {
          ...
          function t(e) {
            var n = e;
            return (
              X.defined(n) && E.is(n.textDocument) && Array.isArray(n.edits)
            );
          }
          (e.create = n), (e.is = t);
        })(v || (v = {})),
      ...
      (function() {
        ...
        Object.defineProperty(e.prototype, "edit", {
          ...
          (e.prototype.deleteFile = function(e, n) {
            this.checkDocumentChanges(),
              this._workspaceEdit.documentChanges.push(_.create(e, n));
          }),
      ...
      (function(e) {
        ...
        (function(e) {
          function n(e) {
            var n = e;
            return X.objectLiteral(e) && S.is(n.kind) && X.string(n.value);
          }
          e.is = n;
        })(T || (T = {})),
        (function(e) {
      ...
      (function(e) {
        ...
        function r(e, n) {
          for (
            ...
            (t = t.substring(0, s) + u.newText + t.substring(c, t.length)),
              (o = s);
          }
          return t;
        }
        function i(e, n) {
          ...
          var a = 0,
            u = 0,
            s = 0;
          while (a < r.length && u < o.length) {
            var c = n(r[a], o[u]);
            e[s++] = c <= 0 ? r[a++] : o[u++];
          }
          while (a < r.length) e[s++] = r[a++];
          while (u < o.length) e[s++] = o[u++];
          return e;
        }
            ...
            (e.prototype._doValidate = function(e, n) {
              this._worker(e)
                ...
                .then(function(t) {
                  ...
                  i.getModeId() === n && monaco.editor.setModelMarkers(i, n, r);
                })
        ...
        return (
          ...
          (e.prototype.provideCompletionItems = function(e, n, t, r) {
            ...
            return this._worker(i)
              .then(function(e) {
                return e.doComplete(i.toString(), ie(n));
              })
              .then(function(t) {
                if (t) {
      ...
      function le(e) {
        if (e) return Array.isArray(e) ? e.map(fe) : [fe(e)];
      }
      var ge = (function() {
        function e(e) {
          this._worker = e;
        ...
        return (
          (e.prototype.provideHover = function(e, n, t) {
            ...
            return this._worker(r)
              .then(function(e) {
                return e.doHover(r.toString(), ie(n));
              })
              .then(function(e) {
                if (e) return { range: ae(e.range), contents: le(e.contents) };
              });
          }),
          e
        );
      ...
      var pe = (function() {
        ...
        return (
          (e.prototype.provideDocumentHighlights = function(e, n, t) {
            ...
            return this._worker(r)
              .then(function(e) {
                return e.findDocumentHighlights(r.toString(), ie(n));
              })
              .then(function(e) {
                if (e)
                  return e.map(function(e) {
                    return { range: ae(e.range), kind: he(e.kind) };
                  });
              });
          }),
          e
      ...
      function me(e) {
        return { uri: Z.parse(e.uri), range: ae(e.range) };
      }
      var ve = (function() {
          function e(e) {
            this._worker = e;
          ...
          return (
            (e.prototype.provideDefinition = function(e, n, t) {
              ...
              return this._worker(r)
                .then(function(e) {
                  return e.findDefinition(r.toString(), ie(n));
                })
                .then(function(e) {
                  if (e) return [me(e)];
                });
        ...
        be = (function() {
          ...
          return (
            (e.prototype.provideReferences = function(e, n, t, r) {
              ...
              return this._worker(i)
                .then(function(e) {
                  return e.findReferences(i.toString(), ie(n));
                })
                .then(function(e) {
                  if (e) return e.map(me);
                });
            }),
            e
          );
        ...
        if (e && e.changes) {
          ...
          for (var t in e.changes) {
            for (var r = [], i = 0, o = e.changes[t]; i < o.length; i++) {
              var a = o[i];
              r.push({ range: ae(a.range), text: a.newText });
            }
            n.push({ resource: Z.parse(t), edits: r });
          }
          return { edits: n };
        }
      }
      var _e = (function() {
        ...
        return (
          (e.prototype.provideRenameEdits = function(e, n, t, r) {
            ...
            return this._worker(i)
              .then(function(e) {
                return e.doRename(i.toString(), ie(n), t);
              })
              .then(function(e) {
                return ye(e);
              });
            ...
            (e.prototype.provideDocumentColors = function(e, n) {
              ...
              return this._worker(t)
                ...
                .then(function(e) {
                  if (e)
                    return e.map(function(e) {
                      return { color: e.color, range: ae(e.range) };
                    });
                });
            }),
                ...
                .then(function(e) {
                  if (e)
                    return e.map(function(e) {
                      ...
                      return (
                        "undefined" !== typeof e.kind && (n.kind = Ee(e.kind)),
                        n
                      );
                    });
                });
      ...
      function Ie(e) {
        var n = new x(e),
          ...
          r = e.languageId;
        monaco.languages.registerCompletionItemProvider(r, new ce(t)),
          monaco.languages.registerHoverProvider(r, new ge(t)),
          monaco.languages.registerDocumentHighlightProvider(r, new pe(t)),
          monaco.languages.registerDefinitionProvider(r, new ve(t)),
          monaco.languages.registerReferenceProvider(r, new be(t)),
          monaco.languages.registerDocumentSymbolProvider(r, new ke(t)),
          monaco.languages.registerRenameProvider(r, new _e(t)),
          monaco.languages.registerColorProvider(r, new xe(t)),
          monaco.languages.registerFoldingRangeProvider(r, new Ce(t)),
          new ne(r, t, e);
      }
...
//# sourceMappingURL=chunk-2d228ca6.923671b2.js.map
