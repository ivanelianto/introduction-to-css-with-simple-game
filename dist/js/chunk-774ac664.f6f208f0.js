  ...
  ["chunk-774ac664"],
  {
    fa5bb: function(e, n, t) {
      ...
      function ie(e) {
        if (e)
          return {
            start: re(e.getStartPosition()),
            end: re(e.getEndPosition())
          };
      }
      function oe(e) {
        if (e)
      ...
      function ge(e) {
        var n = monaco.languages.DocumentHighlightKind;
        switch (e) {
          case j.Read:
            return n.Read;
          case j.Write:
      ...
      var he = (function() {
        ...
        return (
          (e.prototype.provideDocumentHighlights = function(e, n, t) {
            ...
            return this._worker(r)
              .then(function(e) {
                return e.findDocumentHighlights(r.toString(), re(n));
              })
              .then(function(e) {
                if (e)
                  return e.map(function(e) {
                    return { range: oe(e.range), kind: ge(e.kind) };
                  });
              });
          }),
          e
                  ...
                  if (e)
                    return {
                      links: e.map(function(e) {
                        return { range: oe(e.range), url: e.target };
                      })
                    };
                });
            }),
          ...
          return (
            (e.prototype.provideDocumentFormattingEdits = function(e, n, t) {
              ...
              return this._worker(r).then(function(e) {
                return e.format(r.toString(), null, be(n)).then(function(e) {
                  if (e && 0 !== e.length) return e.map(ue);
                });
              });
            }),
            e
          ...
          return (
            (e.prototype.provideDocumentRangeFormattingEdits = function(
              ...
              return this._worker(i).then(function(e) {
                return e.format(i.toString(), ie(n), be(t)).then(function(e) {
                  if (e && 0 !== e.length) return e.map(ue);
                });
              });
            }),
                ...
                .then(function(e) {
                  if (e)
                    return e.map(function(e) {
                      ...
                      return (
                        "undefined" !== typeof e.kind && (n.kind = we(e.kind)),
                        n
                      );
                    });
                });
      ...
      function xe(e) {
        var n = new x(e),
          ...
          r = e.languageId;
        monaco.languages.registerCompletionItemProvider(r, new se(t)),
          monaco.languages.registerHoverProvider(r, new le(t)),
          monaco.languages.registerDocumentHighlightProvider(r, new he(t)),
          monaco.languages.registerLinkProvider(r, new ve(t)),
          monaco.languages.registerFoldingRangeProvider(r, new ke(t)),
          monaco.languages.registerDocumentSymbolProvider(r, new me(t)),
          "html" === r &&
...
//# sourceMappingURL=chunk-774ac664.f6f208f0.js.map
